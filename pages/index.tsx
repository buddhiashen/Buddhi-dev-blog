...
export const Index = ({ posts }: IndexProps): JSX.Element => {
  return (
    <Layout>
      ...
      <p>Hello ! , I&apos;m Buddhi Ashen - curious fullstack student and Python noob based in Colombo, Sri-Lanka. This is my platform that i share my works, how i manage to solve problem when i am doing coding  and programming and many more....</p>
